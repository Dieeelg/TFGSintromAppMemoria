...
A avaliación realizouse sobre as 11 follas escaneadas, empregadas como
...
Listado~\ref{lst:apendice-tesseract-f01} recolle a saída xerada por Tesseract.
...
folla orixinal. O Listado~\ref{lst:apendice-tesseract-f02} permite comprobar
