...
\begin{itemize}
    ...
    \item \textbf{Rede de seguridade familiar:} \textbf{Intégrase} un sistema de notificacións que avisa automaticamente aos coidadores ou familiares en caso de que o paciente se esqueza da súa toma diaria.
