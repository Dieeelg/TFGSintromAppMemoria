...
\begin{itemize}
    ...
    \item \textit{feature/nome-da-tarefa}: utilizouse para desenvolver novas funcionalidades. Algúns exemplos son \textit{feature/calendario},  \textit{feature/confirmar-tomas} ou \textit{feature/vincular-supervisor}
