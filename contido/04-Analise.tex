...
Este capítulo define as funcionalidades que debe proporcionar SintromApp e as condicións baixo as que debe operar. Para describir o comportamento da aplicación escolleuse un enfoque baseado en casos de uso, xa que permite identificar con claridade os actores que interactúan co sistema e os principais obxectivos que poden realizar mediante a aplicación.
