...
O detector mostrou un rendemento elevado no conxunto de validación. A curva Precision-Recall alcanzou un \textit{mAP@0.5} de \textbf{0,989} e a curva F1 acadou un valor máximo de \textbf{0,98} cun limiar de confianza de \textbf{0,603}. Na matriz de confusión rexistráronse \textbf{130 deteccións correctas} da clase \textit{pastilla} e \textbf{5 falsos positivos}.
...
Estes resultados mostran que YOLO permite localizar con elevada fiabilidade as representacións gráficas das pastillas, mesmo ante determinadas variacións de iluminación e distancia.

\subsubsection{Combinación de YOLO e Tesseract}

Unha vez comprobada a capacidade de YOLO para localizar as representacións gráficas das pastillas, realizouse unha proba adicional co obxectivo de determinar se estas deteccións podían empregarse como referencia para recuperar tamén a data e a dose correspondentes.

Para cada detección ampliouse a caixa delimitadora xerada por YOLO e aplicouse sobre o recorte resultante o modelo personalizado de Tesseract \textit{sintromv2}. Probáronse tres tamaños de ampliación, co obxectivo de comprobar se era posible atopar unha rexión que incluíse a información necesaria da cela sen incorporar elementos pertencentes ás celas veciñas.

Os resultados mostraron que o tamaño da rexión condiciona directamente a saída do OCR. Nas ampliacións máis pequenas, o recorte conserva principalmente a representación da pastilla e parte da data, pero pode deixar fóra a dose ou outros elementos necesarios para interpretar a cela. Ao incrementar a rexión é posible incluír unha maior parte da data e da dose, pero comezan a aparecer tamén cabeceiras, valores e información procedente das celas adxacentes.
...
Esta situación pode observarse nos recortes da Figura~\ref{fig:yolo-tesseract-recortes}. A caixa proporcionada por YOLO delimita correctamente a representación gráfica, pero esta non coincide cos límites da cela completa. Como consecuencia, non existe unha ampliación fixa que permita garantir que o OCR reciba exclusivamente a data e a dose
...
Por estes motivos, aínda que YOLO mostrou un bo comportamento na localización das representacións das pastillas, a combinación con Tesseract non se considerou suficientemente robusta para reconstruír automaticamente a pauta completa e descartouse como solución principal.
...
Pola súa parte, YOLO mostrou unha capacidade elevada para localizar as representacións gráficas das pastillas, incluídas fotografías tomadas baixo diferentes condicións de iluminación e distancia. Non obstante, a detección destes elementos constitúe só unha parte do problema, xa que é necesario recuperar tamén a data e a dose correspondente e interpretar as celas nas que
non existe unha representación gráfica.

A combinación de YOLO co modelo personalizado de Tesseract tampouco resolveu esta limitación. A posición das representacións gráficas permitiu aproximar a rexión da cela, pero os diferentes tamaños e disposicións das entradas impediron definir un recorte fixo que recuperase de maneira estable e exclusiva a data e a dose correspondentes. Por este motivo, esta aproximación foi igualmente descartada como solución principal.
