...
Debido a que as imaxes empregadas pola aplicación son fotografías realizadas co móbil, estas poden presentar certa inclinación ou deformación pola perspectiva. Para reducir este problema incorporouse unha etapa previa de preprocesamento mediante OpenCV, aplicada antes de enviar a imaxe ao servizo de extracción.

O procedemento intenta localizar os límites da folla e, cando é posible identificar de maneira fiable a súa xeometría, aplica unha transformación de perspectiva para obter unha vista máis próxima a unha captura frontal. Nos casos nos que non se pode determinar o contorno completo, emprégase como alternativa a orientación das liñas da imaxe para estimar e corrixir a súa
inclinación.

A corrección deseñouse de maneira conservadora, só se modifica a imaxe cando a detección presenta unha confianza suficiente. Se a fotografía xa está correctamente aliñada ou non é posible determinar unha transformación fiable, mantense a imaxe orixinal sen cambios.
...
Para comprobar o funcionamento desta etapa realizáronse varias probas con fotografías das follas tomadas con diferentes graos de inclinación, perspectiva e contraste co fondo. Tamén se comprobou o comportamento ante imaxes xa aliñadas, co obxectivo de evitar aplicar transformacións innecesarias.

Nas fotografías nas que foi posible identificar de maneira fiable a xeometría da folla, o preprocesamento permitiu corrixir a súa orientación e obter unha representación máis próxima a unha captura frontal. A Figura~\ref{fig:opencv-preprocesamento} mostra un exemplo deste proceso.
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{imaxes/06-Procesamento automático das follas de tratamento/T1.jpg}
        \caption{Fotografía orixinal.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{imaxes/06-Procesamento automático das follas de tratamento/RESULTADO-T1.jpg}
...
O enfoque baseado en YOLO mostrou que a detección das representacións gráficas das pastillas pode realizarse con bos resultados, polo que resulta interesante como ferramenta auxiliar. Porén, esta información por si soa non permite reconstruír a pauta completa, xa que existen tamén entradas textuais, como \textit{NO TOMAR} ou \textit{CONTROL}, e continúa sendo necesario
determinar a data e a dose asociadas a cada cela.
