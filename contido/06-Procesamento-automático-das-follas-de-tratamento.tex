...
A avaliación de Azure AI Document Intelligence realizouse comparando os dous modelos personalizados adestrados, \textit{Template} e \textit{Neural}. Primeiro analizáronse as métricas proporcionadas por Azure Document Intelligence Studio ao finalizar o adestramento. No modelo \textit{Template}, mostrado na Figura~\ref{fig:azure-metricas-template}, obtéñense valores elevados na maior parte dos campos: 99,50\,\% para \textit{fecha visita}, \textit{inr}, \textit{farmaco oral} e
