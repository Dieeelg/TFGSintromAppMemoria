...
Nos métodos que si requiriron adestramento realizouse unha división a nivel de documento. As follas \textbf{F01--F08} destináronse ao adestramento, mentres que as follas \textbf{F09--F11} reserváronse exclusivamente para a avaliación. Esta mesma distribución empregouse no modelo personalizado de Tesseract, no detector baseado en \gls{yolo} e nos modelos personalizados de Azure Document Intelligence.
...
Para avaliar esta etapa empregáronse as \textbf{7 fotografías inclinadas} descritas anteriormente, con diferentes graos de inclinación, perspectiva e contraste co fondo. O preprocesamento mediante OpenCV permitiu corrixir correctamente as sete imaxes, mellorando a orientación do documento e, cando foi posible delimitar a folla, reducindo tamén a presenza do fondo exterior. A Figura~\ref{fig:opencv-preprocesamento} mostra un exemplo do resultado obtido.
...
\textbf{iteración 4\,911}, cun \gls{bcer} do \textbf{10,878\,\%} e un \gls{bwer} do \textbf{20,409\,\%}. O punto de control correspondente a este resultado foi empregado para xerar o modelo final \textit{sintromv2}.
...
Para comprobar a capacidade de xeneralización do detector, o modelo final aplicouse sobre as follas F09--F11, que non foran empregadas durante o adestramento nin durante a validación. Para estas probas utilizouse o limiar de confianza de \textbf{0,603} obtido a partir da curva F1.

Nas fotografías tomadas con iluminación normal detectáronse correctamente as \textbf{74 representacións gráficas} presentes nas tres follas. O comportamento mantívose tamén ante cambios nas condicións de captura: con menor iluminación localizáronse \textbf{73 das 74 representacións}, mentres que nas fotografías tomadas a maior distancia se detectaron \textbf{66 das 74}.
