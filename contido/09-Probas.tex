...
Na \gls{api} utilizouse o módulo \textit{unittest} de Python. Probáronse as funcións de limpeza e normalización de datas, a interpretación das doses, o cálculo da confianza media e as regras de validación de valores como o \gls{inr}. Tamén se comprobou o preprocesamento das imaxes con documentos rectos, inclinados, con perspectiva, con dimensións fóra dos límites establecidos ou con ficheiros incorrectos. Incluíronse ademais casos límite para comprobar que un fallo nesta etapa conserva o ficheiro orixinal e non impide a súa análise posterior.
...
A \gls{api} obtivo unha cobertura global do 96,1 \%. Todos os seus módulos alcanzaron o 100 \%, agás o de preprocesamento, cun 93,6 \%. Neste módulo quedaron sen executar algunhas ramas correspondentes a casos específicos e situacións de erro pouco habituais.
