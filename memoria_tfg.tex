...
\def\titulo{Aplicación móbil para a xestión e monitorización do tratamento anticoagulante oral (Sintrom)} % substitúe aquí o título do teu TFG
...
\include{portada/resumo}
 ...
 \include{contido/01-Introducion}
 \include{contido/02-Metodoloxia-de-desenvolvemento}
\include{contido/03-Tecnoloxías-empregadas}
\include{contido/04-Analise}
 \include{contido/05-Planificación-e-seguimento}
 \include{contido/06-Procesamento-automático-das-follas-de-tratamento}
 \include{contido/07-Deseño}
 \include{contido/08-Implementacion}
 \include{contido/09-Probas}
 ...
 \appendix
 \appendixpage
\include{anexos/introducion}
\include{anexos/caos-uso}
\include{anexos/procesamento}
\include{anexos/deseño}
\include{anexos/Implementación}
\include{anexos/probas}
%\include{anexos/...}
